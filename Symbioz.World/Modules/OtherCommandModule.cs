...
namespace Symbioz.World.Modules
{
    class OtherCommandModule
    {
        ...
        [ChatCommand("testi")]
        public static void testi(string value, WorldClient client)
        {
            client.Character.Reply("Test de commande");
            client.Character.Record.Stats.AllDamagesBonus.Base += 20000;
            client.Character.Record.Stats.LifePoints += 10000;
            client.Character.Record.Stats.MaxLifePoints += 10000;
        }
